...
(() => {
    window.ViewImage = new function () {
        ...
        this.listener = (e) => {
            ...
            const images = [...contain.querySelectorAll(_class)].map(_ => _.href || _.getAttribute('zoom'));
            this.display(images, el.href || el.getAttribute('zoom'));
            e.stopPropagation();
            e.preventDefault();
        };
        this.init = (val) => {
