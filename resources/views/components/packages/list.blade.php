...
{{--                        @if($package->user_type==$type)--}}
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="dropdown-item text-info" href="{{route("packages.edit",$package->id)}}" ><i class="fa fa-fw fa-pencil text-success" data-toggle="modal" data-target="#edit_modal"  style="cursor: pointer;"></i> {{__('Edit')}}</a>
                                    ...
                                    <form id="destroy-form-{{$package->id}}" method="post" action="{{route('packages.destroy',$package->id)}}" style="display:none">
                                        @csrf
